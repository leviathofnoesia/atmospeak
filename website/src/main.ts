...
const downloads = [
  {
    ...
    file: "Wind-Speak_0.1.6_x64-setup.exe",
    primary: true,
  },
  {
    label: "Windows MSI",
    detail: "Enterprise-friendly fallback",
    file: "Wind-Speak_0.1.6_x64_en-US.msi",
    primary: false,
  },
  {
    label: "Portable zip",
    detail: "Unzip and run from a folder",
    file: "Wind-Speak_0.1.6_x64-portable.zip",
    primary: false,
  },
  {
    label: "Checksums",
...
function hero() {
  ...
  section.append(specStrip("v0.1.6", "Windows x64", "Offline base.en model bundled"));
  return section;
}
