  ...
  return [
    {
      ...
      fileName: "Wind-Speak_0.1.3_x64-setup.exe",
      kind: "installer",
      url: `${releaseBaseUrl}/Wind-Speak_0.1.3_x64-setup.exe`,
      recommended: true,
    },
    {
      id: "msi",
      label: "Windows MSI",
      fileName: "Wind-Speak_0.1.3_x64_en-US.msi",
      kind: "msi",
      url: `${releaseBaseUrl}/Wind-Speak_0.1.3_x64_en-US.msi`,
      recommended: false,
    },
    {
      id: "portable",
      label: "Portable zip",
      fileName: "Wind-Speak_0.1.3_x64-portable.zip",
      kind: "portable",
      url: `${releaseBaseUrl}/Wind-Speak_0.1.3_x64-portable.zip`,
      recommended: false,
    },
    {
      id: "checksums",
